...
// Imagine you had to write a diary entry to describe how you felt and what you thought about. What would you write?
// Be as detailed as possible!
// If you've exhausted one train of thought, start another.
// Keep typing until the time runs out.

let act_instr_text = `
    <div class="pre_trial_instr">
    <h3>Now, think about your own life.</h3>
     <h4>Recall situations and events that might have been similar to the ones you've just heard and described.</h4>
<!--     <br>-->
     <h4><span id="act_preamble_hl">Imagine you had to write a diary entry to describe how you felt and what you thought about. <br>What would you write?</span></h4>
<!--     <h4><span id='act_preamble_hl'>What would you write?</span><h4>-->
...
<!--    <p>Keep typing until the time runs out</p>-->
    ...
    <p>If you've exhausted one train of thought, start another.</p>
...
let act_preamble_text = "<span id='act_preamble_hl'>CREATE YOUR</span> DIARY ENTRY"
